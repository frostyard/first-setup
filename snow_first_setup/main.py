...
def main(version, moduledir: str, localedir: str):
    ...
    gettext.install('snow-first-setup', localedir)

    resource = Gio.Resource.load(os.path.join(moduledir, 'snow-first-setup.gresource'))
    resource._register()

    import snow_first_setup.core.backend as backend
    from snow_first_setup.application import FirstSetupApplication
