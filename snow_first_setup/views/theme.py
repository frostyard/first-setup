...
@Gtk.Template(resource_path="/org/frostyard/FirstSetup/gtk/theme.ui")
class VanillaTheme(Adw.Bin):
    ...
    def __set_wallpaper_assets(self):
        ...
        try:
            ...
            default_pixbuf = GdkPixbuf.Pixbuf.new_from_resource("/org/frostyard/FirstSetup/assets/background_replacement.png")
