...
from snow_first_setup.views.locations import VanillaLocation

import snow_first_setup.core.keyboard as kbd
import snow_first_setup.core.timezones as tz
import snow_first_setup.core.backend as backend

_ = __builtins__["_"]

@Gtk.Template(resource_path="/org/frostyard/FirstSetup/gtk/keyboard.ui")
