...
@Gtk.Template(resource_path="/org/frostyard/FirstSetup/gtk/widget-location-list-page.ui")
...
@Gtk.Template(resource_path="/org/frostyard/FirstSetup/gtk/location.ui")
